# Projeto - Efeito Borboleta
# Suas decisões irão criar varios finais diferentes baseados nas respostas que forem dadas
...
class Destino:
    ...
    def Iniciar(self):
        ...
        # criar a janela
        self.janela = sg.Window('Destino!',layout=layout)
        while True:
            # ler os dados
            self.LerValores()
